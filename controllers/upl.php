...
// $$p_name = $_POST['user_id'];


	 $name = $_SESSION['p_name'];
	 if (isset($name)) {
		$slc = "SELECT * FROM `users` where p_name= '$name'";
...
$insert = "INSERT INTO contentupload(upl_company, upl_cnt_person, upl_desig, upl_email, upl_num, upl_tel, upl_website, upl_select, upl_address, upl_img, user_id ) VALUES('$upl_company','$upl_cnt_person','$upl_desig','$upl_email','$upl_num', '$upl_tel', '$upl_website','$upl_select','$upl_address','$upl_name','$id')";    
